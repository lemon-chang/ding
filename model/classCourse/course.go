...
func GetIsHasCourse(lesson int, startWeek int, userType int, useridList []string, week int) (byClass ByClass, err error) {
	...
	URL := fmt.Sprintf("http://110.40.228.197:8886/course/findUserByClass?lesson=%v&page=0&startWeek=%v&userType=%v&useridList=%v&week=%v&pageSize=100", lesson, startWeek, userType, useridListString, week)
